  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans p-6 md:p-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-black/40 border border-white/5 rounded-2xl py-4 pl-12 pr-4 focus:outline-none focus:border-amber-500/40 transition"
              />
            </div>
            
            <div className="relative group">
              <select className="w-full bg-black/40 border border-white/5 rounded-2xl py-4 px-6 appearance-none focus:outline-none focus:border-amber-500/40 cursor-pointer">
            ...
            <button className="bg-amber-500 text-black font-bold rounded-2xl hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20 active:scale-95">
              Apply Filters
            </button>
          </div>
        </div>
        ...
        {/* Bottom CTA Section */}
        <div className="mt-24 p-12 rounded-[3rem] bg-gradient-to-br from-amber-500/10 to-transparent border border-white/5 text-center relative overflow-hidden">
