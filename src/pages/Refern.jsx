...
const Refern = () => {
  ...
  return (
    // આખા પેજનું વ્રેપર (Wrapper)
    <div className="flex flex-col min-h-screen bg-[#050505]">
      
      {/* મેઈન કન્ટેન્ટ સેક્શન - flex-grow ફૂટરને નીચે રાખશે */}
      <main className="flex-grow py-12 md:py-24 px-4 md:px-6 text-white relative overflow-x-hidden">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md overflow-y-auto">
          <div className="bg-[#111] border border-white/10 w-full max-w-lg rounded-3xl p-6 md:p-8 relative shadow-2xl my-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-amber-500 text-black font-bold py-4 rounded-xl mt-4 hover:bg-amber-400 transition-all shadow-lg shadow-amber-500/20 active:scale-95">
                Submit Referral
              </button>
            </form>
          </div>
