            ...
            {products.map((product) => (
              <div key={product.id} className="group flex flex-col">
                ...
                <div className="relative aspect-[3/4.5] w-full bg-[#0a0a0a] rounded-[3.5rem] overflow-hidden border border-white/5 shadow-2xl transition-all duration-700 group-hover:border-amber-500/50">
                  ...
                  {/* Top Content */}
                  <div className="absolute top-10 inset-x-10 z-20">

                    {product.tag && (
                      <div className="mb-6">
                        <div className="inline-block bg-amber-500 text-black px-5 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest shadow-xl shadow-amber-500/20">
                          {product.tag}
                        </div>
                      </div>
                    )}
                  ...
                  <div className="absolute bottom-10 inset-x-10 z-20">
                    <p className="text-amber-500 text-[9px] font-black uppercase tracking-[0.3em] mb-6 border-l-2 border-amber-500 pl-4">
                      Benefits
                    </p>
                    ...
                    <ul className="space-y-4 mb-10">
                      {product.features.map((f, i) => (
                        <li
                          key={i}
                          className="text-xs text-gray-200 font-bold flex items-center gap-3"
                        >
                    ...
                    <button
                      onClick={() => {
                        if (product.name === "Essential_Placement_Program")
                          navigate("/starter");

                        if (product.name === "Strategic_Placement_Program")
                          navigate("/professional");

                        if (product.name === "Platinum_Placement_Program")
                          navigate("/executive");
                      }}
