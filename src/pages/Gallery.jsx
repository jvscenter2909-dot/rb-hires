...
const Gallery = () => {
  ...
  return (
    // આખા પેજને flex-col અને min-h-screen આપ્યું છે જેથી ફૂટર નીચે સેટ થાય
    <div className="flex flex-col min-h-screen bg-[#050505]">
      
      {/* મુખ્ય કન્ટેન્ટ એરિયા */}
      <main className="flex-grow py-12 md:py-24 px-4 sm:px-6 font-sans text-white overflow-x-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Filter Section */}
          <div className="flex justify-start md:justify-center items-center gap-2 md:gap-3 mb-10 md:mb-16 border-b border-white/5 pb-6 overflow-x-auto no-scrollbar touch-pan-x">
            {categories.map(category => (
              <button
                key={category}
                onClick={() => setActiveFilter(category)}
      ...
      <style jsx>{`
        ...
        .card-animation { animation: fadeInScale 0.5s ease-out forwards; }
      `}</style>
    </div>
  );
};
